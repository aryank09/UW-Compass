...
const strings: Record<Locale, UIStrings> = {
  en: {
    ...
    aboutArchNoteBody:
      'Three OpenAI calls per request: 1 embedding + 2 chat completions. The first two run in parallel. Resource embeddings are computed once at seed time, never per request.',
    ...
    aboutTechStorageDetail: 'Static JSON bundled into the deploy',
  ...
  es: {
    ...
    aboutTechStorageDetail: 'JSON estático incluido en el despliegue',
  ...
  zh: {
    ...
    aboutTechStorage: '存储',
    aboutTechStorageDetail: '打包进部署的静态 JSON',
    aboutTechTesting: '测试',
  ...
  vi: {
    ...
    aboutTechStorageDetail: 'JSON tĩnh đóng gói trong bản triển khai',
  ...
  ko: {
    ...
    aboutTechStorageDetail: '배포에 번들된 정적 JSON',
