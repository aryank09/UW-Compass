      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 sm:p-8 mb-8">
        <form onSubmit={submit} className="space-y-6">
          ...
          <textarea
            ...
            className="w-full rounded-xl border border-slate-300 bg-slate-50 px-5 py-4 text-base shadow-inner focus:bg-white focus:border-uw-spirit-purple focus:outline-none focus:ring-4 focus:ring-uw-spirit-purple/20 transition-all resize-none"
            disabled={loading}
          />
